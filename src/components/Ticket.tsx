    ...
    useEffect(() => {
        async function fetchData() {
            try {
                ...
                if (params.numFactura) {
                    const resVentas = await axios.get("/api/ventas/factura/" + params.numFactura);
    ...
    return (
        <section>
            ...
            <section className='informacion-factura'>
                <p>CAI: {dataMore.cai}</p>
                <p>Rango de Facturación Inicial: {dataMore.FacturacionInicial}</p>
                <p>Rango de Facturación Final: {dataMore.FacturacionFinal}</p>
                <p>Fecha Limite de Emisión: {formatDate(dataMore.fechaLimiteEmision)}</p>
                <hr />
            ...
            <section className="metodo-pago">
                <p id="letras"></p>
                <p>Metodo de Pago: {dataMore.metodopago}</p>
                <p>Efectivo: L. {formatNumber(dataMore.efectivo)}</p>
                <p>Cambio: L. {formatNumber(dataMore.cambio)}</p>
            </section>
            <hr />
            <section className="final">
                <p>Original: Cliente / Copia: Obligado tributario emisor</p>
                <p>LA FACTURA ES DE BENEFICIO DE TODOS <br /> ¡EXIGALA!</p>
            </section>
        </section>
    );
}
