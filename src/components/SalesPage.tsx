  ...
  React.useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        ...
        const idVenta = await loadData("https://inhands-mu.vercel.app/detalleVenta");
            ...
            <React.Fragment>
              ...
              <ModalBody >
                <div>
                  ...
                  <Input placeholder='Nombre del Cliente' value={nombreCliente} readOnly/>
                </div>
                <div>
                  <p>RTN del Cliente:</p>
                  <Input placeholder='RTN del Cliente' value={rtnCliente} readOnly/>
                </div>
                <div>
                  <p>Metodo de Pago</p>
                  <RadioGroup
